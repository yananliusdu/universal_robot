...
def move_to_position(position, orientation):
    ...
    goal = moveit_msgs.msg.ArmPoseGoal()
    goal.pose.header = std_msgs.msg.Header(frame_id=('base_link'))
...
action_address = '/base_link/pose_action/tool_pose'
position_client = None

def init():
    global position_client
    position_client = actionlib.SimpleActionClient(action_address, moveit_msgs.msg.ArmPoseAction)
